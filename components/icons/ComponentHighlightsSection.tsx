            ...
            >
              ...
              >
                <Flex gap="2" align="start" mb="1" mr="-1">
                  <LightningBolt />
                  <Heading as="h3" size="3">
                    Aspek Perpajakan yang tersusun otomatis
                  </Heading>
                </Flex>
                <Text as="p" size="2" ml="6">
              ...
              >
                <Flex gap="2" align="start" mb="1">
                  <LightningBolt />
                  <Heading as="h3" size="3">
                    Update materi perpajakan terbaru
                  </Heading>
                </Flex>
                <Text as="p" size="2" ml="6">
                  Kami selalu terdepan untuk memberikan informasi terbaru terkait perpajakan, Anda
                  yang pertama yang kami informasikan.
                </Text>
              </Box>
              ...
              >
                <Flex gap="2" align="start" mb="1">
                  <LightningBolt />
                  <Heading as="h3" size="3">
                    Perbaikan SOP perusahaan
                  </Heading>
                </Flex>
                <Text as="p" size="2" ml="6">
                  Kami memberikan saran-saran kecil untuk perbaikan SOP perpajakan perusahaan
                </Text>
              </Box>
              ...
              >
                <Flex gap="2" align="start" mb="1">
                  <LightningBolt />
                  <Heading as="h3" size="3">
                    Saran yang sesuai kondisi perusahaan
                  </Heading>
                </Flex>
                <Text as="p" size="2" ml="6">
                  Setiap perusahaan memiliki usaha yang berbeda, saran perpajakan pun akan
